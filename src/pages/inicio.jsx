...
export default function Inicio() {
  ...
  // Función para manejar la redirección cuando el botón es presionado
  const handleAgendaCitaClick = () => {
    // Verifica si hay una sesión iniciada (por ejemplo, comprobando un token o una cookie)
    const isLoggedIn = document.cookie.includes("session_id") || localStorage.getItem("session_id");

    if (isLoggedIn) {
      // Si hay una sesión iniciada, redirige a la página de citas
      navigate("/citas");
    } else {
